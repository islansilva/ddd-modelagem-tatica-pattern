...
describe("Domain events tests", () => {
    ...
    it("should notify all events handler when Customer is created", () => {
        ...
        eventDispatcher.register("CustomerCreatedEvents", spyEvent1Handler);
        eventDispatcher.register("CustomerCreatedEvents", spyEvent2Handler);

        expect(eventDispatcher.getEventHandlers["ProductCreatedEvent"][0]).toMatchObject(spyEvent1Handler);
